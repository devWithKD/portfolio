      ...
      <PopInDiv>
        <div className="text-zinc-800 dark:text-zinc-50">
          ...
          <p className="mb-4 text-zinc-700 dark:text-zinc-200 font-light">
            ...
            Management System with a microcontroller. This little project set
            off a massive passion for programming in me. My curiosity and
            excitement have been on the rise ever since.
          </p>
          <p className="mb-4 text-zinc-700 dark:text-zinc-200 font-light">
            ...
            projects, showcasing my multidisciplinary background. I&apos;m
            excited to see what the next phase of this captivating journey
            brings!
          </p>
          ...
          <div className=" grid grid-cols-2 sm:grid-cols-3 gap-5 ">
            <ProjectCard
              title="Cadence"
              link="https://cadence.devwithkd.com/"
